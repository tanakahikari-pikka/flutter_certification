...
class FourChoiceQuestion extends StatefulWidget {
  const FourChoiceQuestion({super.key});

  @override
  State<FourChoiceQuestion> createState() => _FourChoiceQuestionState();
}

class _FourChoiceQuestionState extends State<FourChoiceQuestion> {
  ...
  List<Map<String, dynamic>> questionAndAnswers = [
    ...
    },
    {
      ...
      "answer": "2017/5/12",
      "explanationOfAnswer": "https://github.com/flutter/flutter/releases/tag/v0.0.6",
      "choices": ["2017/5/12", "2018/12/4", "2021/3/3", "2023/9/31"],
    },
    {
      "question": "Flutter の初期バージョンの呼び名は？",
      "answer": "Sky",
      "explanationOfAnswer": "https://arstechnica.com/gadgets/2015/05/googles-dart-language-on-android-aims-for-java-free-120-fps-apps/",
    ...
    },
    {
      ...
      "answer": "FlutterFlow",
      "explanationOfAnswer": "",
      "choices": ["FlutterCustom", "FlutterStudio", "FlutterBuilder", "FlutterFlow"],
    },
  ];
  ...
  nextQuestion() {
    ...
    if (questionNumbers.isEmpty) {
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) {
            return Result(correctAnswersCount: correctAnswersCount, questionCount: questionAndAnswers.length);
          },
        ),
      );
    } else {
  ...
  makeChoice(choice) async {
    ...
    final String explanationOfAnswer = questionAndAnswers[currentQuestionNumber]["explanationOfAnswer"];
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(questionAndAnswers[currentQuestionNumber]["question"],
                      style: const TextStyle(
                        fontSize: 20,
                        color: Colors.black,
                        height: 1.5,
                ...
                ListView.builder(
                  ...
                  itemCount: questionAndAnswers[currentQuestionNumber]["choices"].length,
                  itemBuilder: (BuildContext context, int i) {
                    return choiceTile(questionAndAnswers[currentQuestionNumber]["choices"][i]);
                  },
                ),
                Row(
